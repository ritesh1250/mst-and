package  com.meest.storyview.customview
...
class CustomProgressiveStoryView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyle: Int = 0
) : LinearLayout(context, attrs, defStyle) {

    private val progressBars: MutableList<CustomProgressBar> = ArrayList()
    ...
    init {
        ...
        val typedArray = context.obtainStyledAttributes(attrs,
            R.styleable.CustomProgressiveStoryView
        )
        storiesCount = typedArray.getInt(R.styleable.CustomProgressiveStoryView_progressCount, 0)
        typedArray.recycle()
        bindViews()
    }
    ...
    private fun createProgressBar(): CustomProgressBar {
        return CustomProgressBar(context).apply {
            layoutParams =
    ...
    private fun callback(index: Int): CustomProgressBar.Callback {
        return object : CustomProgressBar.Callback {
    ...
    fun getProgressWithIndex(index: Int): CustomProgressBar {
