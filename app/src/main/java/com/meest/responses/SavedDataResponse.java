...
public class SavedDataResponse {
    ...
    public class Row {
        ...
        @SerializedName("savedPostFolderId")
        @Expose
        private String savedPostFolderId;
        ...
        public String getSavedPostFolderId() {
            return savedPostFolderId;
        }

        public void setSavedPostFolderId(String savedPostFolderId) {
            this.savedPostFolderId = savedPostFolderId;
        }
