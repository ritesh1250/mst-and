...
public class GalleryFoldersActivityMedley extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(GalleryFoldersActivityMedley.this,
                Manifest.permission.READ_EXTERNAL_STORAGE)
                != PackageManager.PERMISSION_GRANTED)
            ActivityCompat.requestPermissions(GalleryFoldersActivityMedley.this,
        ...
        if (folds.isEmpty()) {
            ...
            RecyclerView.Adapter folderAdapter = new PictureFolderAdapterMedley(folds, GalleryFoldersActivityMedley.this, filter, call_type);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == LAUNCH_SECOND_ACTIVITY) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                Log.e("Calltype", ""+call_type_result);
                Log.e("Calltype", ""+result);
        ...
        }  else if (requestCode == LAUNCH_SECOND_ACTIVITY1) {
            if (resultCode == Activity.RESULT_OK) {
                String result = data.getStringExtra("result");
                String call_type_result = data.getStringExtra("call_type");
                Log.e("Calltype1", "" + call_type_result);
                Log.e("Calltype1", "" + result);
                Intent returnIntent = new Intent();
                returnIntent.putExtra("result", result);
                returnIntent.putExtra("call_type", call_type_result);
                setResult(Activity.RESULT_OK, returnIntent);
