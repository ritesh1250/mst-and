...
public class GalleryItemDisplayActivityMedley extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (allpictures.isEmpty()) {
            ...
            imageRecycler.setAdapter(new PictureAdapterMedley(allpictures, GalleryItemDisplayActivityMedley.this, filter, call_type));
...
//                popup.show();
    ...
    public ArrayList<PictureFacer> getAllImagesByFolder(String path) {
        ...
        Cursor cursor = GalleryItemDisplayActivityMedley.this.getContentResolver().query(allimagesuri, projection, MediaStore.Images.Media.DATA + " like ? ", new String[]{"%" + path + "%"}, null);
        try {
            cursor.moveToFirst();
            do {
...
//                Log.e("Image path",cursor.getString(cursor.getColumnIndexOrThrow(MediaStore.Images.Media.DATA)));
    ...
    public ArrayList<PictureFacer> getAllVideoByFolder(String path) {
        ...
        Cursor cursor_video = GalleryItemDisplayActivityMedley.this.getContentResolver().query(allVideosuri, projection_video, MediaStore.Video.Media.DATA + " like ? ", new String[]{"%" + path + "%"}, null);
        try {
