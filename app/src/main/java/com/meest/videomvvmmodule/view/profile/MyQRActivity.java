...
import com.meest.R;
import com.meest.databinding.ActivityMyQRBinding;
...
public class MyQRActivity extends BaseActivity {
        ...
        try {
            ...
            for (int x = 0; x < width; x++) {
                for (int y = 0; y < height; y++) {
                    bitmap.setPixel(x, y, bitMatrix.get(x, y) ? getColor(R.color.new_action_color) : Color.WHITE);
                }
            }
    ...
    private void saveQRForQ() {
        ...
        try {
            ...
            Toast.makeText(this, getResources().getString(R.string.qr_saved), Toast.LENGTH_SHORT).show();
