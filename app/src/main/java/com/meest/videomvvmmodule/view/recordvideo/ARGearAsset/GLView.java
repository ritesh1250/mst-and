...
//        int glviewWidth = ((BaseActivity)getContext()).getGLViewWidth();
//        int glviewHeight = ((BaseActivity)getContext()).getGLViewHeight();
...
/*
        if(glviewWidth > 0 && glviewHeight > 0) {
            ...
            ((BaseActivity)getContext()).setMeasureSurfaceView(this);
        }else{
