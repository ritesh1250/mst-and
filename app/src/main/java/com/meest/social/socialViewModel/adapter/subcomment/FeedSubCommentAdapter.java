...
public class FeedSubCommentAdapter extends RecyclerView.Adapter<FeedSubCommentAdapter.ViewHolder> {

    private VideoCommentReplyActivityNew context;
    private List<FeedSubCommentResponse.Row> subComment;
    boolean isAd;

    public FeedSubCommentAdapter(VideoCommentReplyActivityNew context, List<FeedSubCommentResponse.Row> subComment, boolean isAd) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        // showing only one comment
        final FeedSubCommentResponse.Row model = subComment.get(position);
        try {
        ...
        if (subComment.get(position).getUserId().equalsIgnoreCase(SharedPrefreances.getSharedPreferenceString(holder.itemView.getContext(), SharedPrefreances.ID))) {
        ...
        holder.binding.txtDelate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                body.put("commentId", subComment.get(position).getId());
                        ...
                        call.enqueue(new Callback<ApiResponse>() {
                            ...
                            public void onResponse(Call<ApiResponse> call, Response<ApiResponse> response) {
                                ...
                                if (response.code() == 200 && response.body() != null && response.body().getSuccess()) {
                                    Utilss.showToast(context, "deleted successfully", R.color.green);
