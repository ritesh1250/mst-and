...
public class InterestChooseAdapter1 extends RecyclerView.Adapter<InterestChooseAdapter1.ViewHolder> {

    private final Context mContext;
    private List<String> mData;
    InterestChooseAdapter1.OnItemClickListener mItemClickListener;
    ...
    public InterestChooseAdapter1(Context context, List<String> mData, OnItemClickListener mItemClickListener) {
        mContext = context;
        this.mData = mData;
        this.mItemClickListener = mItemClickListener;
    }
    ...
    @NonNull
    @Override
    public InterestChooseAdapter1.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemLayoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.choose_fav_adapter, null);
        return new InterestChooseAdapter1.ViewHolder(itemLayoutView);
    }

    @Override
    public void onBindViewHolder(@NonNull InterestChooseAdapter1.ViewHolder holder, int position) {
