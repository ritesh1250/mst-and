...
import com.meest.R;
import com.meest.databinding.ImageHashtagChildBinding;
...
public class HashTagImageAdapter extends RecyclerView.Adapter<HashTagImageAdapter.HashtagHolder> {
    ...
    public HashTagImageAdapter(Context context, List<VideoSearchResponse.Row> videosList,
    ...
    @NonNull
    @Override
    public HashTagImageAdapter.HashtagHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.image_hashtag_child, parent, false);
        return new HashTagImageAdapter.HashtagHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull HashTagImageAdapter.HashtagHolder holder, int position) {
    ...
    public class HashtagHolder extends RecyclerView.ViewHolder {
        ...
        ImageHashtagChildBinding binding;
