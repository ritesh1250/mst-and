...
public class SubCommentHalfAdapter extends RecyclerView.Adapter<SubCommentHalfAdapter.ViewHolder> {

    private Context context;
    private List<VideoCommentResponse.VideoSubComment> subComment;
    private Boolean isSvs, isAd;
   VideoCommentAdapter callback;

    public SubCommentHalfAdapter(Context context, List<VideoCommentResponse.VideoSubComment> subComment, Boolean isSvs, VideoCommentAdapter callback, boolean isAd) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        final VideoCommentResponse.VideoSubComment model = subComment.get(0);
        ...
        if (model.getUser().getId().equalsIgnoreCase(SharedPrefreances.getSharedPreferenceString(holder.itemView.getContext(), SharedPrefreances.ID))) {
