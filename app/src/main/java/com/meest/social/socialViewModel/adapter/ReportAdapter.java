...
public class ReportAdapter extends RecyclerView.Adapter<ReportAdapter.ReportHolder> {
    ...
    private String key;
    private List<ReportTypeResponse.ReportName> reportList;
    private final String id;
    private RecyclerView.Adapter adaptor;
    String type;

    public ReportAdapter(Context context, ReportTypeResponse reportTypeResponse,
    ...
    public void onBindViewHolder(@NonNull ReportHolder holder, int position) {
        ReportTypeResponse.ReportName model = reportList.get(position);
        holder.report_option.setText(model.getName());
...
//                        Utilss.showToast(context, "Server Error", R.color.msg_fail);
    ...
    public class ReportHolder extends RecyclerView.ViewHolder {
        ...
        TextView report_option;

        public ReportHolder(@NonNull View itemView) {
            super(itemView);
            report_option = itemView.findViewById(R.id.report_option);
        }
    }
}
