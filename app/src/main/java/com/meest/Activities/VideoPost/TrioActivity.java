...
public class TrioActivity extends AppCompatActivity /*implements Player.EventListener*/ {
    ...
    boolean toggleClick = false, isTimerSet;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.trio_activity);
...
//        tvStartShooting.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
...
//                SELECTED_TIME_PROGRESS = CURRENT_VIDEO_PROGRESS + bubbleSeekBar.getProgress();
//                isTimerSet = true;
        ...
        ivVideoDone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (filepathListTemp.size() > 1) {
                    ...
                    hidePrd();
                    Intent intent = new Intent(TrioActivity.this, PostVideoActivity.class);
...
//        }
   ...
   /* private void setupExoPlayer() {
        ...
        dataSourceFactory = new DefaultDataSourceFactory(this,
                Util.getUserAgent(this, "tunemist"));
        MediaSource mediaSource = new HlsMediaSource.Factory(dataSourceFactory).createMediaSource(Uri.parse(videoUrl));
...
//    }
    ...
    private void openExitConfirmDialog() {
        ...
        alertDialog.setMessage("Discard current sound and recording progress?");
