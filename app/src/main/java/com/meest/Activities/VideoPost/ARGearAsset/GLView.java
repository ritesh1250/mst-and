...
public class GLView extends GLSurfaceView implements GLSurfaceView.Renderer {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int glviewWidth = ((BaseCameraActivity)getContext()).getGLViewWidth();
        int glviewHeight = ((BaseCameraActivity)getContext()).getGLViewHeight();
        ...
        if(glviewWidth > 0 && glviewHeight > 0) {
            ...
            ((BaseCameraActivity)getContext()).setMeasureSurfaceView(this);
        }else{
