...
public class PostVideoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.acv_video_post:
                ...
                Log.v("harsh", "videoFile.getPath() == " + videoFile.getPath());
                ...
                Call<VideoUploadResponse> call = webApi.uploadVideo(header, vFile);
    ...
    private void showError() {
        Utilss.showToast(PostVideoActivity.this, getString(R.string.error_msg), R.color.grey);
        loading.cancelAnimation();
        loading.setVisibility(View.GONE);
    }
