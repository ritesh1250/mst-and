...
public class UserInterestAdapter extends RecyclerView.Adapter<UserInterestAdapter.ViewHolder>{
    ...
    UserInterestAdapter.OnItemClickListener mItemClickListener;
    ...
    public UserInterestAdapter(Context context, List<String> mData, OnItemClickListener mItemClickListener){
        mContext = context;
        this.mData = mData;
        this.mItemClickListener = mItemClickListener;
    }
    ...
    public UserInterestAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new UserInterestAdapter.ViewHolder(itemLayoutView);
    }
