...
//                    shareMessage = shareMessage + "https://play.google.com/store/apps/details?id=" + BuildConfig.APPLICATION_ID + "\n\n";
    ...
    private void refreshAd() {
        ...
        AdLoader adLoader = builder.withAdListener(new AdListener() {
            ...
            public void onAdFailedToLoad(int errorCode) {
                Toast.makeText(Mainactivity.this, getString(R.string.Failed_to_load_native_ad) + errorCode, Toast.LENGTH_SHORT).show();
            }
        }).build();
    ...
    private void refreshAd(final Dialog dialog) {
        ...
        AdLoader adLoader = builder.withAdListener(new AdListener() {
            @Override
            public void onAdFailedToLoad(int errorCode) {
                Toast.makeText(Mainactivity.this, getString(R.string.Failed_to_load_native_ad)
