package com.meest.videoEditing.listvideowithmymusic;
...
public class SelectVideoFragment extends Fragment {
    ...
    public boolean b() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            this.c.add(new VideoData(managedQuery.getString(managedQuery.getColumnIndexOrThrow("_display_name")), withAppendedPath, managedQuery.getString(managedQuery.getColumnIndex("_data")), ContentUtill.getTime(managedQuery, getString(R.string.duration))));
