package com.meest.videoEditing.videojoiner.adapter;
        ...
        holder.b.setOnClickListener(new OnClickListener() {
            @Override public void onClick(View view) {
                ...
                if (!z) {
                    ...
                    Toast.makeText(RecyclerAlbumGridAdapter.this.b, b.getString(R.string.Select_Maximum_two_Videos), 0).show();
                }
            }
        });
        return inflate;
