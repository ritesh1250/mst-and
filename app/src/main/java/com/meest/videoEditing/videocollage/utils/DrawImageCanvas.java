package com.meest.videoEditing.videocollage.utils;
    ...
    public Bitmap drawCanvas() {
        ...
        for (int i3 = 0; i3 < Utils.clgstickerviewsList.size(); i3++) {
            try {
                ...
                com.meest.videoEditing.videocollage.BitmapUtils.Utils.width = clgSingleFingerView.getImageWidth();
                ...
                if (bitmapDrawable.getBitmap() != null) {
                    try {
                        ...
                        Bitmap createScaledBitmap = Bitmap.createScaledBitmap(bitmap, com.meest.videoEditing.videocollage.BitmapUtils.Utils.width, imageHeight, true);
