package com.meest.videoEditing.videocollage.stickers;
...
import com.meest.R;
import com.meest.videoEditing.Styleable;
...
public class ClgSingleFingerView extends LinearLayout {
    ...
    public ClgSingleFingerView(Context context, AttributeSet attributeSet, int i2) {
        ...
        View inflate = View.inflate(context, R.layout.clg_single_finger, null);
        addView(inflate, -1, -1);
