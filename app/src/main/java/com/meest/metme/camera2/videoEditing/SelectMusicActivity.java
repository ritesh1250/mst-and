...
import com.meest.R;
import com.meest.metme.camera2.videoEditing.audiovideomixer.AddAudio;
...
//                ads.BannerAd(SelectMusicActivity.this,s);
                ...
                this.e.setOnClickListener(new OnClickListener() {
                    @Override public void onClick(View view) {
                        com.meest.metme.camera2.videoEditing.SelectMusicActivity.this.finish();
                    }
                });
                try {
                    ...
                    MusicViewPagerAdapter musicAdapter = new MusicViewPagerAdapter(this, R.layout.selectmusic_row, ab(""), new String[]{"artist", "album", "title", "duration", "_size"}, iArr);
                    this.a = musicAdapter;
