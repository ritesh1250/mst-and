...
import com.meest.R;
import com.meest.metme.camera2.photoEditor.base.BaseActivity;
import com.meest.metme.camera2.photoEditor.filters.FilterListener;
import com.meest.metme.camera2.photoEditor.filters.FilterViewAdapter;
import com.meest.metme.camera2.photoEditor.tools.EditingToolsAdapter;
import com.meest.metme.camera2.photoEditor.tools.ToolType;
...
public class EditImageActivity extends BaseActivity implements OnPhotoEditorListener,
   ...
   PropertiesBSFragment mPropertiesBSFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bitmap = CameraUtil.bitmap;
        // get the imageUri from the PreviewImageActivity
...
//        }
        ...
        //Get imageUri and change to bitmap
        //imageUriToBitmap(imageUri);
...
//                TextEditorDialogFragment.show(this, text, colorCode);
    ...
    private void saveBitmap() {
        ...
        Bitmap bitmap = Bitmap.createBitmap(mPhotoEditorView.getDrawingCache());
        Intent intent = new Intent(this, PreviewImageActivity.class);
        CameraUtil.bitmap = bitmap;
...
//
//        //Log.e(TAG, "Screenshot imageUri: "+imageUri);
//        Intent resultIntent = new Intent();
//        resultIntent.putExtra("imageUri", imageUri.toString());
//        setResult(RESULT_OK,resultIntent);
//        finish();
        mPhotoEditorView.setDrawingCacheEnabled(false);
    }
    ...
    private void showSaveDialog() {
        ...
        builder.setPositiveButton("Save", (dialog, which) -> saveBitmap());
