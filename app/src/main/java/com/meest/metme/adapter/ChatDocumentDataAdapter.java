...
public class ChatDocumentDataAdapter extends RecyclerView.Adapter<ChatDocumentDataAdapter.DoctumentViewHolder> implements Filterable {
    ...
    public ChatDocumentDataAdapter(ArrayList<GetDocsMediaChatsResponse.Data.LastWeek> mediaDocumentList, Context context) {
    ...
    @NonNull
    @Override
    public DoctumentViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.docyument_item_list, parent, false);
        DoctumentViewHolder DVH = new DoctumentViewHolder(v);
        return DVH;
    }

    @Override
    public void onBindViewHolder(@NonNull DoctumentViewHolder holder, int position) {
