...
public class HashtagVideoMeeshoAdapter extends RecyclerView.Adapter<HashtagVideoMeeshoAdapter.HashtagHolder> {
    ...
    public HashtagVideoMeeshoAdapter(Context context, List<VideoSearchResponse.Row> videosList,
